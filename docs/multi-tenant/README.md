...
6. [Unificação de Login + Seleção de Loja](06-unificacao-login-selecao-loja.md) — documento histórico da fase anterior (`/super-admin` e `/t/:slug/login`), supersedido pelo login global em `/login`.
