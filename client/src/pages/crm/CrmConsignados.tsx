...
export default function CrmConsignados() {
  ...
  const isConsignacao = (user as any)?.sellerDepartment === 'consignacao';
  // Consignacao dept users can always move cards (they manage the process)
  const canMoveAny = isAdmin || isGerente || isConsignacao;
