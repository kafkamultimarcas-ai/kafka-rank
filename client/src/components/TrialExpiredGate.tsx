...
/**
 * Overlay global e não-fechável, exibido quando o trial da loja
      ...
      <div className="racing-card max-w-md w-full p-8 text-center">
        ...
        {subscriptionSuspended ? (
          ...
          <>
            ...
            <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
              Os {TRIAL_PERIOD_DAYS} dias grátis da loja no {brandName} chegaram ao fim. Contrate uma assinatura pra continuar usando a
              plataforma sem interrupção.
            </p>
          </>
        )}
